...
import com.appbusters.robinkamboj.senseitall.view.test_activity.tests.headphone_jack_test_fragment.ReceiverAudio;
...
public class JackFragment extends FeatureFragment implements JackInterface {
    ...
    public void initializeBasicInformation() {
        ...
        addToDetailsList(sensorDetails, "Is Jack Plugged In", String.valueOf(audioManager.isWiredHeadsetOn()));

        addToDetailsList(sensorDetails, "Is Speaker Phone On", String.valueOf(audioManager.isSpeakerphoneOn()));
        addToDetailsList(sensorDetails, "Is Microphone Mute", String.valueOf(audioManager.isMicrophoneMute()));
        addToDetailsList(sensorDetails, "Is Music Active", String.valueOf(audioManager.isMusicActive()));
