...
public class CustomCalcSettings {
    ...
    CustomCalcSettings() {
        ...
        decimalSep = CustomCalcDialog.FORMAT_CHAR_DEFAULT;
        groupSep = CustomCalcDialog.FORMAT_CHAR_DEFAULT;
        groupSize = 3;
    ...
    void setValue(@Nullable BigDecimal value) {
        if (value != null && maxValue != null && CustomCalcDialogUtils.isValueOutOfBounds(value, maxValue)) {
    ...
    void setMaxValue(@Nullable BigDecimal maxValue) {
        ...
        if (initialValue != null && CustomCalcDialogUtils.isValueOutOfBounds(initialValue, maxValue)) {
    ...
    void setMaxDigits(int intPart, int fracPart) {
        if (intPart != CustomCalcDialog.MAX_DIGITS_UNLIMITED && intPart < 1 ||
                fracPart != CustomCalcDialog.MAX_DIGITS_UNLIMITED && fracPart < 0) {
    ...
    void setFormatSymbols(char decimalSep, char groupSep) {
        if (decimalSep != CustomCalcDialog.FORMAT_CHAR_DEFAULT && decimalSep == groupSep) {
