package com.appbusters.robinkamboj.senseitall.ui.tool_activity.everyday_tools.calculator.calc;
...
public class CustomCalcDialog extends AppCompatDialogFragment {


    private static final String TAG = CustomCalcDialog.class.getSimpleName();
    ...
    private CustomCalcPresenter presenter;

    private CustomCalcSettings settings;
     ...
     */
    public CustomCalcDialog() {
        settings = new CustomCalcSettings();
    }
     ...
     * @return the dialog
     */
    public static CustomCalcDialog newInstance(int requestCode) {
        CustomCalcDialog dialog = new CustomCalcDialog();
    ...
    Dialog onCreateDialog(final Bundle state) {
        ...
        // Erase button
        CustomCalcEraseButton eraseBtn = view.findViewById(R.id.calc_btn_erase);
        eraseBtn.setOnEraseListener(new CustomCalcEraseButton.EraseListener() {
            @Override
            public void onErase() {
        ...
        cancelBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((ToolActivity) Objects.requireNonNull(getActivity())).onBackPressed();
            }
        });
        ...
        dialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialogInterface) {
                ...
                // Presenter
                presenter = new CustomCalcPresenter();
                presenter.attach(CustomCalcDialog.this, state);
            }
        });
    ...
    @Nullable
    private CustomCalcDialog.CalcDialogCallback getCallback() {
        CustomCalcDialog.CalcDialogCallback cb = null;
        if (getParentFragment() != null) {
            try {
                cb = (CustomCalcDialog.CalcDialogCallback) getParentFragment();
            } catch (Exception e) {
                // Interface callback is not implemented in fragment
            }
        } else if (getTargetFragment() != null) {
            try {
                cb = (CustomCalcDialog.CalcDialogCallback) getTargetFragment();
            } catch (Exception e) {
                // Interface callback is not implemented in fragment
            }
        } else {
            ...
            try {
                cb = (CustomCalcDialog.CalcDialogCallback) requireActivity();
            } catch (Exception e) {
    ...
    ////////// VIEW METHODS //////////
    CustomCalcSettings getSettings() {
        return settings;
    }

    Locale getDefaultLocale() {
        return CustomCalcDialogUtils.getDefaultLocale(context);
    }
    ...
    void sendValueResult(BigDecimal value) {
        CustomCalcDialog.CalcDialogCallback cb = getCallback();
        if (cb != null) {
     ...
     * @return the dialog
     */
    public CustomCalcDialog setValue(@Nullable BigDecimal value) {
     ...
     * @return the dialog
     */
    public CustomCalcDialog setMaxValue(@Nullable BigDecimal maxValue) {
     ...
     * @return the dialog
     */
    public CustomCalcDialog setMaxDigits(int intPart, int fracPart) {
     ...
     * @return the dialog
     */
    public CustomCalcDialog setRoundingMode(RoundingMode roundingMode) {
     ...
     * @return the dialog
     */
    public CustomCalcDialog setSignCanBeChanged(boolean canBeChanged, int sign) {
     ...
     * @return the dialog
     */
    public CustomCalcDialog setFormatSymbols(char decimalSep, char groupSep) {
     ...
     * @return the dialog
     */
    public CustomCalcDialog setClearDisplayOnOperation(boolean clear) {
     ...
     * @return the dialog
     */
    public CustomCalcDialog setShowZeroWhenNoValue(boolean show) {
     ...
     * @return the dialog
     */
    public CustomCalcDialog setGroupSize(int size) {
     ...
     * @return the dialog
     */
    public CustomCalcDialog setShowAnswerButton(boolean show) {
     ...
     * @return the dialog
     */
    public CustomCalcDialog setShowSignButton(boolean show) {
