...
//    public static final String RATE_YOUR_EXPERIENCE = "RATE YOUR EXPERIENCE";
    ...
    public static HashMap<String, Integer> toolImageUrlMap = new HashMap<>();
...
//        trendingNames.add(AUGMENTED_REALITY);
        ...
        toolImageUrlMap.put(SENSOR_LIGHT, R.drawable.baseline_highlight_black_48);
        toolImageUrlMap.put(SENSOR_PROXIMITY, R.drawable.baseline_pan_tool_black_48);
        toolImageUrlMap.put(SENSOR_TEMPERATURE, R.drawable.baseline_brightness_5_black_48);
        toolImageUrlMap.put(SENSOR_PRESSURE, R.drawable.baseline_terrain_black_48);
        toolImageUrlMap.put(SENSOR_ACCELEROMETER, R.drawable.baseline_trending_up_black_48);
        toolImageUrlMap.put(SENSOR_RELATIVE_HUMIDITY, R.drawable.baseline_scatter_plot_black_48);
        toolImageUrlMap.put(SENSOR_GYROSCOPE, R.drawable.baseline_360_black_48);
        toolImageUrlMap.put(SENSOR_GRAVITY, R.drawable.baseline_system_update_black_48);
        toolImageUrlMap.put(SENSOR_LINEAR_ACCELERATION, R.drawable.baseline_trending_flat_black_48);
        toolImageUrlMap.put(SENSOR_ROTATION_VECTOR, R.drawable.baseline_360_black_48);
        toolImageUrlMap.put(SENSOR_STEP_DETECTOR, R.drawable.baseline_directions_walk_black_48);
        toolImageUrlMap.put(SENSOR_STEP_COUNTER, R.drawable.baseline_directions_run_black_48);
        toolImageUrlMap.put(SENSOR_MOTION_DETECTOR, R.drawable.baseline_directions_bike_black_48);
        toolImageUrlMap.put(SENSOR_STATIONARY_DETECTOR, R.drawable.baseline_airline_seat_recline_normal_black_48);
        toolImageUrlMap.put(SENSOR_MAGNETIC_FIELD, R.drawable.baseline_public_black_48);
        toolImageUrlMap.put(SENSOR_HEART_RATE, R.drawable.baseline_favorite_black_48);
        toolImageUrlMap.put(BACK_CAMERA, R.drawable.baseline_camera_rear_black_48);
        toolImageUrlMap.put(FRONT_CAMERA, R.drawable.baseline_camera_front_black_48);
        toolImageUrlMap.put(GPS_LOCATION, R.drawable.baseline_gps_fixed_black_48);
        toolImageUrlMap.put(WIFI, R.drawable.baseline_network_wifi_black_48);
        toolImageUrlMap.put(BLUETOOTH, R.drawable.baseline_bluetooth_black_48);
        toolImageUrlMap.put(GSM_UMTS, R.drawable.baseline_sim_card_black_48);
        toolImageUrlMap.put(COMPASS, R.drawable.baseline_compass_calibration_black_48);
        toolImageUrlMap.put(RADIO, R.drawable.baseline_radio_black_48);
        toolImageUrlMap.put(SCREEN, R.drawable.baseline_smartphone_black_48);
        toolImageUrlMap.put(BATTERY, R.drawable.baseline_battery_alert_black_48);
        toolImageUrlMap.put(CPU, R.drawable.baseline_memory_black_48);
        toolImageUrlMap.put(SOUND, R.drawable.baseline_volume_off_black_48);
        toolImageUrlMap.put(VIBRATOR, R.drawable.baseline_vibration_black_48);
        toolImageUrlMap.put(AV_OUTPUTS, R.drawable.baseline_headset_mic_black_48);
        toolImageUrlMap.put(ANDROID_OS, R.drawable.baseline_adb_black_48);
        toolImageUrlMap.put(FLASH, R.drawable.baseline_flash_on_black_48);
        toolImageUrlMap.put(INFRARED, R.drawable.baseline_wb_sunny_black_48);
        toolImageUrlMap.put(MULTI_TOUCH, R.drawable.baseline_settings_cell_black_48);
        toolImageUrlMap.put(FINGERPRINT, R.drawable.baseline_fingerprint_black_48);
        toolImageUrlMap.put(NFC, R.drawable.baseline_nfc_black_48);
        toolImageUrlMap.put(MICROPHONE, R.drawable.baseline_mic_none_black_48);
        toolImageUrlMap.put(USB_ACCESSORY, R.drawable.baseline_usb_black_48);
        toolImageUrlMap.put(BAROMETER, R.drawable.baseline_pool_black_48);
        toolImageUrlMap.put(WIFI_DIRECT, R.drawable.baseline_cast_black_48);
        toolImageUrlMap.put(HEART_RATE_ECG, R.drawable.baseline_favorite_border_black_48);
        toolImageUrlMap.put(FAKE_TOUCH, R.drawable.baseline_touch_app_black_48);
        toolImageUrlMap.put(WEB_VIEW, R.drawable.baseline_web_black_48);
        toolImageUrlMap.put(MIDI, R.drawable.baseline_speaker_black_48);
        toolImageUrlMap.put(VR_MODE, R.drawable.baseline_videogame_asset_black_48);
        toolImageUrlMap.put(STORAGE, R.drawable.baseline_storage_black_48);
        toolImageUrlMap.put(RAM, R.drawable.baseline_memory_black_48);
        toolImageUrlMap.put(PIE, R.drawable.p);
        toolImageUrlMap.put(OREO, R.drawable.o);
        toolImageUrlMap.put(NOUGAT, R.drawable.n);
        toolImageUrlMap.put(MARSHMALLOW, R.drawable.m);
        toolImageUrlMap.put(LOLLIPOP, R.drawable.l);
        toolImageUrlMap.put(KITKAT, R.drawable.k);
        toolImageUrlMap.put(AUGMENTED_REALITY, R.drawable.ar);
        toolImageUrlMap.put(VIRTUAL_REALITY, R.drawable.vr);
        toolImageUrlMap.put(MOTION_DETECT, R.drawable.motion);
        toolImageUrlMap.put(FACE_DETECT, R.drawable.face);
        toolImageUrlMap.put(FACE_EMOJI, R.drawable.emoji);
        toolImageUrlMap.put(BARCODE_READER, R.drawable.barcode);
        toolImageUrlMap.put(TEXT_SCAN, R.drawable.baseline_text_format_black_48);
        toolImageUrlMap.put(LABEL_GENERATOR, R.drawable.baseline_speaker_notes_black_48);
        toolImageUrlMap.put(CALENDAR, R.drawable.baseline_today_black_48);
        toolImageUrlMap.put(WEATHER, R.drawable.baseline_wb_cloudy_black_48);
        toolImageUrlMap.put(REMINDER, R.drawable.baseline_note_black_48);
        toolImageUrlMap.put(SET_ALARM, R.drawable.baseline_alarm_black_48);
        toolImageUrlMap.put(INTERNET_SPEED, R.drawable.baseline_trending_up_black_48);
        toolImageUrlMap.put(VOLUME_CONTROL, R.drawable.baseline_speaker_phone_black_48);
        toolImageUrlMap.put(TAKE_NOTE, R.drawable.baseline_note_add_black_48);
        toolImageUrlMap.put(QUICK_SETTINGS, R.drawable.baseline_settings_black_48);
        toolImageUrlMap.put(CROP_IMAGE, R.drawable.baseline_crop_black_48);
        toolImageUrlMap.put(SQUARE_IMAGE, R.drawable.baseline_crop_square_black_48);
        toolImageUrlMap.put(IMAGE_FILTERS, R.drawable.baseline_local_florist_black_48);
        toolImageUrlMap.put(EDIT_IMAGE, R.drawable.baseline_tune_black_48);
        toolImageUrlMap.put(CHECKLIST, R.drawable.baseline_spellcheck_black_48);
        toolImageUrlMap.put(RECORD_AUDIO, R.drawable.baseline_record_voice_over_black_48);
        toolImageUrlMap.put(CALCULATOR, R.drawable.baseline_exposure_plus_1_black_48);
        toolImageUrlMap.put(SOUND_LEVEL, R.drawable.baseline_volume_up_black_48);
        toolImageUrlMap.put(STOP_WATCH, R.drawable.baseline_watch_later_black_48);
        toolImageUrlMap.put(TIMER, R.drawable.baseline_watch_later_black_48);
        toolImageUrlMap.put(DRAW_NOTE, R.drawable.baseline_edit_black_48);
