package com.appbusters.robinkamboj.senseitall.ui.detail_activity.sensors.gravity_sensor;
...
public class GravityFragment extends SensorFragment implements GravityInterface {
    ...
    public void initializeBasicInformation() {
        ...
        addToDetailsList(sensorDetails, "Venus' Gravity", String.valueOf(SensorManager.GRAVITY_VENUS));
        addToDetailsList(sensorDetails, "Earth's Gravity", String.valueOf(SensorManager.GRAVITY_EARTH));
        addToDetailsList(sensorDetails, "Mars' Gravity", String.valueOf(SensorManager.GRAVITY_MARS));
        ...
        addToDetailsList(sensorDetails, "Uranus' Gravity", String.valueOf(SensorManager.GRAVITY_URANUS));
